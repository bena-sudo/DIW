...
class ArcElement extends Element {
  ...
  inRange(chartX, chartY, useFinalPosition) {
    ...
    const nonZeroBetween =
      ...
      startAngle !== endAngle;
    const betweenAngles =
      _circumference >= helpers_segment.TAU || nonZeroBetween;
...
function containsDefaultColorsDefenitions() {
  return (
    helpers_segment.defaults.borderColor !== "rgba(0,0,0,0.1)" ||
    helpers_segment.defaults.backgroundColor !== "rgba(0,0,0,0.1)"
  );
}
var plugin_colors = {
  id: "colors",
